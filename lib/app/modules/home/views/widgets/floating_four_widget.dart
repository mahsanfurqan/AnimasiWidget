...
class FloatingFourWidget extends StatefulWidget {
  const FloatingFourWidget({
    super.key,
    required this.width,
  ...
  @override
  State<FloatingFourWidget> createState() => _FloatingFourWidgetState();
}

class _FloatingFourWidgetState extends State<FloatingFourWidget>
    with SingleTickerProviderStateMixin {
  static const List<_FloatingFourSpec> _objects = [
    _FloatingFourSpec(
    ...
    _FloatingFourSpec(
      kind: _FloatingFourKind.fractionPie,
      leftFactor: 0.40,
      topFactor: 0.55,
      widthFactor: 0.070,
      pulseScaleAmplitude: 0.085,
    ...
    _FloatingFourSpec(
      kind: _FloatingFourKind.triangle,
      leftFactor: 0.42,
      topFactor: 0.19,
      widthFactor: 0.032,
      pulseScaleAmplitude: 0.085,
    ...
    _FloatingFourSpec(
      kind: _FloatingFourKind.multiply,
      leftFactor: 0.50,
      topFactor: 0.09,
      widthFactor: 0.032,
      pulseScaleAmplitude: 0.085,
                  ...
                  child: Transform.rotate(
                    ...
                    child: Transform.scale(
                      ...
                      child: switch (object.kind) {
                        _FloatingFourKind.asset => SvgPicture.asset(
                          object.asset!,
                          width: objectWidth,
                          fit: BoxFit.contain,
                        ),
                        _FloatingFourKind.circle => _MiniGlyph(
                          type: _MiniGlyphType.circle,
                          size: objectWidth,
                        ),
                        _FloatingFourKind.triangle => _MiniGlyph(
                          type: _MiniGlyphType.triangle,
                          size: objectWidth,
                        ),
                        _FloatingFourKind.fractionPie => _MiniGlyph(
                          type: _MiniGlyphType.fractionPie,
                          size: objectWidth,
                        ),
                        _FloatingFourKind.plus => _MiniGlyph(
                          type: _MiniGlyphType.plus,
                          size: objectWidth,
                        ),
                        _FloatingFourKind.minus => _MiniGlyph(
                          type: _MiniGlyphType.minus,
                          size: objectWidth,
                        ),
                        _FloatingFourKind.divide => _MiniGlyph(
                          type: _MiniGlyphType.divide,
                          size: objectWidth,
                        ),
                        _FloatingFourKind.multiply => _MiniGlyph(
...
class _FloatingFourSpec {
  const _FloatingFourSpec({
    this.asset,
    this.kind = _FloatingFourKind.asset,
